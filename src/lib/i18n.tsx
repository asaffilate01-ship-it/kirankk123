...
const DICT: Record<string, string> = { ...DE, ...DE_EXTRA, ...DE_OMNIQORA, ...DE_KIEZIO, ...DE_MOTORESQ, ...DE_MARELYRA, ...DE_EASTAMIRA, ...DE_UX, ...DE_LEGAL, ...DE_INVESTOR, ...DE_BRAND_CORRECTIONS };
