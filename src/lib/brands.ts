...
const BASE_BRANDS: Brand[] = [
  ...
  },
  {
    ...
    reason: "Care providers fail CQC inspections on evidence, not on care \u2014 paper MAR charts, missed visits and handover gaps. AMITYOS captures the evidence as care happens.",
  ...
  },
  {
    ...
    name: "HACCORA UK",
    region: "UK",
    tagline: "Digital HACCP and food-safety compliance for UK hospitality",
    domain: "haccora.co.uk",
    description: "The UK edition of HACCORA: digital HACCP diaries, fridge and probe temperature logs, allergen matrices (Natasha's Law), cleaning schedules and audit-ready evidence packs mapped to the Food Standards Agency's Safer Food, Better Business framework and the Food Hygiene Rating Scheme.",
    ...
    proposition: "One subscription per site: staff sign off checks on a phone or tablet in seconds, Bluetooth probes and fridge sensors log automatically, allergen matrices generate from recipes, and a single tap produces the evidence pack an EHO asks for. Reuses the German HACCORA engine, so UK pricing undercuts incumbents.",
    features: [
    ...
    currentMarket: {
      howServed: "Most UK kitchens still use FSA paper SFBB packs or a wall clipboard, with photos of fridge dials in a WhatsApp group. Digital adoption is concentrated in chains using Trail or Navitas; independents are largely unserved.",
