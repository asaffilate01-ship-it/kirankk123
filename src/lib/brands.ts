...
const BASE_BRANDS: Brand[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Merqano-admin, business-admin and shopper roles with strict separation between customer websites",
      ...
      "Customer-business onboarding, subscription plans, payment setup and optional white-label branding",
    ...
    apps: [
      {
        ...
        kind: "Web",
        purpose: "Each customer business's branded shop with browsing, basket, delivery or collection choices and checkout",
      },
      {
      ...
      {
        name: "MERQANO Platform Admin",
        kind: "Admin",
        purpose: "Customer onboarding, subscriptions, support, permissions, payment setup and platform analytics",
      },
    ],
    userTypes: [
      {
        type: "Merqano platform team",
        useCase: "Onboards customer businesses, manages plans and support, and monitors platform reliability.",
      },
      {
        type: "Customer business owner or store manager",
      ...
      {
        type: "Shopper",
        useCase: "Buys from the customer business's own branded website using its checkout and delivery choices.",
      },
    ],
    competitors: [
      {
        name: "Single-store commerce platforms",
        strength: "Mature storefront, checkout and extension ecosystems",
        counter: "Merqano gives each customer an independent branded ecommerce website while the shared technology, onboarding, updates and support are managed centrally",
      },
      {
        name: "Plugin-based and bespoke shop builds",
      ...
      },
      {
        ...
        counter: "Customer businesses keep their own brand, customer relationship and sales data on their independent ecommerce website",
      },
    ],
    risks: [
      {
      ...
      {
        risk: "One customer business accesses another customer's data",
        mitigation: "Every record is assigned to one customer website with database-level access controls and server-side enforcement, audited before every release.",
      },
      {
        risk: "Established commerce platforms reduce prices or add stronger multi-store tools",
        mitigation: "Focus on fast customer-site onboarding, separate business data, practical built-in commerce tools and centrally managed support.",
      },
    ],
    currentMarket: {
