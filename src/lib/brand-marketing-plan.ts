...
const TRACTION_EN: Record<string, string> = {
  ...
  kalethon: "Pre-list venues, invite them to claim and verify profiles, and sell only to venues; use free player and organiser demand to prove utilisation and booking certainty.",
...
const TRACTION_DE: Record<string, string> = {
  ...
  kalethon: "Sportstätten vorlisten, zum Claim und zur Prüfung einladen und ausschließlich an Locations verkaufen; kostenlose Nachfrage von Spielern und Organisatoren belegt Auslastung und Buchungssicherheit.",
